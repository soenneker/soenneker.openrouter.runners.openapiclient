...
using Soenneker.OpenRouter.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.OpenRouter.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["OpenRouter:ClientGenerationUrl"] ?? "https://openrouter.ai/openapi.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "OpenRouterOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
